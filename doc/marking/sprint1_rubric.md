...
## User Stories (Tracked in Trello) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 (tasks not assigned a person)
...
---
## Tracking on Trello  (max 20 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Trello? (max 2 marks)
    ...
    Your Mark: 1 (there's not a PR for each task)
  ...
  Your Mark: 1 (same comment as above)
...
Your Mark: 2 (slight nitpick, git commit messsages are supposed to be in present tense)
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 0 (hard to tell on trello who's assigned to what task)
...
Tracking on Trello Total Mark: 15 / 20
...
Try and make it clear on trello who's responsible for what task, and make a PR for each task.
