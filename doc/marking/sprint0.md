...
**Team Name:** [hireme]  
**Github:** [https://github.com/CSC301H5/finalprojectw23-hireme.git]  
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  - All user stories identify goal/desire and all identify why/benefit (max 2 marks) 
    ...
    Your mark: 1
    - missing "so that" statement for some user stories
...
proposal: 
This is an interesting idea! Perhaps your application can aggregate previous piazza posts? Assuming that all piazza posts have been categorized appropriately by students, and TA’s have been ensuring that is in fact the case, this application can be used by instructors to provide students access to previous piazza posts, from previous offerings, about text book questions or other such questions that do not relate to assignments or tests to maintain academic integrity.
